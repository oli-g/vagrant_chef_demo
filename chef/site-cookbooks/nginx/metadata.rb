...
attribute "nginx/temp_dir",
  :display_name => "Nginx Temp Directory",
  :description => "Location for Nginx temp files",
  :default => "/var/tmp/nginx"
...
attribute "nginx/status_page",
  :display_name => "Enable Nginx status page",
  :default => "true"
